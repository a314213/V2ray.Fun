...
if [ ${Debian_version} == 9 ];then
	wget -N --no-check-certificate https://raw.githubusercontent.com/a314213/V2ray.Fun/master/enable-debian9-rclocal.sh
...
#Install V2ray.Fun
cd /usr/local/
git clone https://github.com/a314213/V2ray.Fun
